...
string cinPlace() {
    ...
    while (true) {
        if (_kbhit()) { // Проверяем, нажата ли клавиша
            ...
            else if (isCyrillic(ch)&&data.size()<35) {
                data += ch;
                cout << ch; // Выводим символ на консоль
            }
        }
...
int main() {
    ...
    while (run) {
        if (states.current_state == "main_menu") {
            ...
            while (true) {
                system("cls");
                system("mode con cols=73 lines=16");
            ...
            string hello = "  |                     Приветствуем, ";
            while (true) {
                system("mode con cols=73 lines=19");
                coutFromFile("./ASCII/lk.txt");
                cout << "\n  =====================================================================\n";
                hello += user.name;
                hello += ".";
            ...
            cout << "\nОбъявление отправлено на модерацию! Переход в личный кабинет...";
            Sleep(1500);
            if (user.status_user == "0") {
                states.setState("lk");
            }
